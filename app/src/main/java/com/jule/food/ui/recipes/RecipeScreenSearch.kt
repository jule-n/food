...
fun RecipeScreenSearch(
    ...
    Row(
        ...
        SearchBar(
            inputField = {
                RecipeScreenSearchInputField(
                    textFieldState = textFieldState,
                    searchBarExpanded = expanded,
                    onChangeSearchBarExpanded = onChangeExpanded
                )
            },
            expanded = expanded,
            onExpandedChange = {
...
@Composable
fun RecipeScreenSearchInputFieldPreview() {
    var searchBarExpanded by remember { mutableStateOf(false) }
    FoodTheme {
        RecipeScreenSearchInputField(
            textFieldState = rememberTextFieldState(),
            searchBarExpanded = searchBarExpanded,
            onChangeSearchBarExpanded = { searchBarExpanded = it }
        )
    }
}
...
@Preview(showBackground=true)
@Composable
fun RecipeScreenSearchPreview() {
    var searchBarExpanded by remember { mutableStateOf(false) }
    FoodTheme {
        RecipeScreenSearch(
            expanded = searchBarExpanded,
            onChangeExpanded = { searchBarExpanded = it },
            textFieldState = rememberTextFieldState(),
            interactionSource = remember { MutableInteractionSource() },
            recipes = listOf(),
            recentRecipeIds = listOf(),
            onClickRecipe = { id -> }
        )
    }
}