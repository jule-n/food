package com.jule.food.ui.settings
...
import com.jule.food.data.colorSettingDisplay
import com.jule.food.data.languageSettingsDisplay
import com.jule.food.data.languageSettingsFlags
import com.jule.food.data.themeSettingDisplay
    ...
    Scaffold(
        ...
        Column(modifier = Modifier.padding(innerPadding), verticalArrangement = Arrangement.spacedBy(15.dp), horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            SettingsScreenCategory(name = stringResource(R.string.data)) {
                Setting(icon = { Icon(painter = painterResource(id = R.drawable.import_data), contentDescription = "Import") }, name = stringResource(
                    R.string.import_data), onClick = onPickFile)
                Setting(icon = { Icon(painter = painterResource(id = R.drawable.export_data), contentDescription = "Export") }, name = stringResource(
                    R.string.export), onClick = onExport)
            }
        }
            ...
            DefaultDialog(
                ...
                Column {
                    DialogCheckbox(
                        ...
                        onCheckedChange = { groceriesChecked = it },
                        label = stringResource(R.string.groceries),
                        modifier = Modifier.width(200.dp)
                    )
                    DialogCheckbox(
                        checked = recipeChecked,
                        onCheckedChange = { recipeChecked = it },
...
fun SelectColor(
    ...
    Setting(icon = { Icon(painter = painterResource(id = R.drawable.palette), contentDescription = "Color", tint = selectedColor) }, name = stringResource(
        R.string.colors), onClick = { showDialog = true }, currentSetting = stringResource(
        colorSettingDisplay[currentColorSetting]!!), modifier = modifier)
    if (showDialog)
    {
...
fun SelectLanguage(
    ...
    Setting(icon = { Icon(painter = painterResource(id = R.drawable.language), contentDescription = "Language") }, name = stringResource(
        R.string.language), onClick = { showDialog = true }, currentSetting = stringResource(
        languageSettingsDisplay[currentLanguage]!!), modifier = modifier)
...
fun SettingsPreview() {
    ...
    FoodTheme(darkTheme = darkTheme, colorSetting = colorSetting) {
        SettingsScreen(darkTheme = darkTheme, themeSetting = themeSetting, onPickFile = { }, onExport = {}, onChangeTheme = { themeSetting = it }, colorSetting = colorSetting, onChangeColor = { colorSetting = it }, language = language, onChangeLanguage = { language = it }, bottomBar = {
            BottomNavigationBar(
                navController = navController,
                recipeViewModel = viewModel()
            )
        }, onBack = {}, importingFile = null, onCancelImport = {}, onStartImport = {})
    }
}