    ...
    Column(modifier = Modifier.padding(bottom=10.dp, start = 10.dp, end = 10.dp)) {
        ...
        FlowRow(
            ...
            allLocations.forEach { location ->
                val selected = location.id == selectedLocation
                ...
                Surface(
                    ...
                    color = color,
                    onClick = { if (!selected) onSelectLocation(location.id) },
//                        modifier = Modifier.sharedElement(
//                            sharedContentState = rememberSharedContentState(location.id),
//                            animatedVisibilityScope = LocalNavAnimatedVisibilityScope.current!!
//                        )
                ) {
                    Text(location.name, modifier = Modifier.padding(10.dp))
                }
            }
        }
//        }
...
fun EditLocationButtons(
    ...
    val addLocationFocusRequester = remember { FocusRequester() }
    val motionScheme = MaterialTheme.motionScheme
    ...
    var locationIdToDelete: UUID? by remember { mutableStateOf(null) }
        ...
        Column(modifier = modifier.fillMaxSize()
            ...
            LazyColumn(
                ...
                items(allLocations, key = { it.id }) { location ->
                    val textState = rememberTextFieldState(location.name)
                    ...
                    ReorderableItem(
                        ...
                        Column(modifier = Modifier.animateItem()) {
                            ...
                            AnimatedVisibility(showItems) {
                                Text(location.groceryNames.joinToString(separator = ", "))
                            }
    ...
    if (showConfirmDeleteLocationDialog && locationIdToDelete != null) {
        ...
        DeleteDialog(
            ...
            onConfirm = {
                ...
                onRemoveLocation(locationIdToDelete!!)
                showConfirmDeleteLocationDialog = false
                locationIdToDelete = null
            }
        ) {
