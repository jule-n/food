...
import com.jule.food.ui.settings.ImportResult
...
import com.jule.food.data.HandleLifeCycle
import com.jule.food.data.Languages
import com.jule.food.data.LocationViewModel
import com.jule.food.data.RecipeViewModel
import com.jule.food.data.SettingsViewModel
import com.jule.food.data.ThemeSetting
import com.jule.food.data.createImageFilesFromPaths
import com.jule.food.data.createZipExportFile
import com.jule.food.data.exportFileToLocation
import com.jule.food.data.getImportDataFromFile
import com.jule.food.data.handleJsonIntent
...
//        var jsonContent by mutableStateOf( handleJsonIntent(this, intent) )
        ...
        setContent {
            ...
            LaunchedEffect(true) {
                ...
                locationViewModel.groceryViewModel = groceryViewModel
                locationViewModel.recipeViewModel = recipeViewModel
                locationViewModel.getFromFile(context)
            ...
            FoodTheme(darkTheme = darkTheme, colorSetting = settingsViewModel.colorSetting) {
                    NavigationHost(
                        ...
                        onChangeLanguage = { AppCompatDelegate.setApplicationLocales(LocaleListCompat.forLanguageTags(
                            localeOptions[it])) },
                        groceryViewModel = groceryViewModel,
                        recipeViewModel = recipeViewModel,
                        locationViewModel = locationViewModel,
                        ...
                        onStartJsonImport = {
                            ...
                            if (json != null) {
                                Log.d("onStartJsonImport", "Json import successful: \"$json\"")
                                jsonContent = json
                            } else {
                                Log.d("onStartJsonImport", "Json import failed")
