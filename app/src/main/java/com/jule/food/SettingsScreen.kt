    ...
    Scaffold(
        ...
        topBar = {
            CenterAlignedTopAppBar(
                ...
                navigationIcon = {
                    IconButtonWithTooltip(onClick = onBack, modifier = Modifier.size(50.dp), tooltipText = stringResource(R.string.back)) { Icon(painter = painterResource(R.drawable.arrow_left), contentDescription = stringResource(R.string.back)) }
                }
            )
        },
