...
fun SpecificRecipeTags(
    ...
    SpecificRecipeSection(
        ...
        actionButtons = {
            FilledExpressiveIconButtonWithTooltip(onClick = { tagSelectionDialogActive = true }, shapes = IconButtonDefaults.shapes(), tooltipText = stringResource(R.string.select_tags)) {
